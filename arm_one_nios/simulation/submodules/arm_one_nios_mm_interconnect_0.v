...
module arm_one_nios_mm_interconnect_0 (
	...
	wire    [5:0] rsp_mux_002_src_channel;                                                          // rsp_mux_002:src_channel -> hps_0_h2f_axi_master_agent:write_rp_channel
	...
	wire    [5:0] rsp_mux_003_src_channel;                                                          // rsp_mux_003:src_channel -> hps_0_h2f_axi_master_agent:read_rp_channel
	...
	wire    [5:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> nios_cpu_1_debug_mem_slave_agent:cp_channel
	...
	wire  [126:0] led_s1_agent_rp_data;                                                             // led_s1_agent:rp_data -> router_011:sink_data
	...
	wire    [5:0] router_src_channel;                                                               // router:src_channel -> nios_cpu_1_data_master_limiter:cmd_sink_channel
	...
	wire    [5:0] nios_cpu_1_data_master_limiter_cmd_src_channel;                                   // nios_cpu_1_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [5:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios_cpu_1_data_master_limiter:rsp_sink_channel
	...
	wire    [5:0] nios_cpu_1_data_master_limiter_rsp_src_channel;                                   // nios_cpu_1_data_master_limiter:rsp_src_channel -> nios_cpu_1_data_master_agent:rp_channel
	...
	wire    [5:0] router_001_src_channel;                                                           // router_001:src_channel -> nios_cpu_1_instruction_master_limiter:cmd_sink_channel
	...
	wire    [5:0] nios_cpu_1_instruction_master_limiter_cmd_src_channel;                            // nios_cpu_1_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [5:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios_cpu_1_instruction_master_limiter:rsp_sink_channel
	...
	wire    [5:0] nios_cpu_1_instruction_master_limiter_rsp_src_channel;                            // nios_cpu_1_instruction_master_limiter:rsp_src_channel -> nios_cpu_1_instruction_master_agent:rp_channel
	...
	wire    [5:0] router_004_src_channel;                                                           // router_004:src_channel -> hps_0_h2f_lw_axi_master_wr_limiter:cmd_sink_channel
	...
	wire    [5:0] hps_0_h2f_lw_axi_master_wr_limiter_cmd_src_channel;                               // hps_0_h2f_lw_axi_master_wr_limiter:cmd_src_channel -> cmd_demux_004:sink_channel
	...
	wire    [5:0] rsp_mux_004_src_channel;                                                          // rsp_mux_004:src_channel -> hps_0_h2f_lw_axi_master_wr_limiter:rsp_sink_channel
	...
	wire    [5:0] router_005_src_channel;                                                           // router_005:src_channel -> hps_0_h2f_lw_axi_master_rd_limiter:cmd_sink_channel
	...
	wire    [5:0] hps_0_h2f_lw_axi_master_rd_limiter_cmd_src_channel;                               // hps_0_h2f_lw_axi_master_rd_limiter:cmd_src_channel -> cmd_demux_005:sink_channel
	...
	wire    [5:0] rsp_mux_005_src_channel;                                                          // rsp_mux_005:src_channel -> hps_0_h2f_lw_axi_master_rd_limiter:rsp_sink_channel
	...
	wire    [5:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> sdram_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> mutex_0_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] mutex_0_s1_burst_adapter_source0_channel;                                         // mutex_0_s1_burst_adapter:source0_channel -> mutex_0_s1_agent:cp_channel
	...
	wire  [126:0] cmd_mux_005_src_data;                                                             // cmd_mux_005:src_data -> led_s1_burst_adapter:sink0_data
	...
	wire  [126:0] cmd_demux_004_src1_data;                                                          // cmd_demux_004:src1_data -> cmd_mux_005:sink0_data
	...
	wire  [126:0] cmd_demux_005_src1_data;                                                          // cmd_demux_005:src1_data -> cmd_mux_005:sink1_data
	wire          cmd_demux_005_src1_ready;                                                         // cmd_mux_005:sink1_ready -> cmd_demux_005:src1_ready
	wire    [5:0] cmd_demux_005_src1_channel;                                                       // cmd_demux_005:src1_channel -> cmd_mux_005:sink1_channel
	...
	wire  [126:0] rsp_demux_005_src0_data;                                                          // rsp_demux_005:src0_data -> rsp_mux_004:sink1_data
	...
	wire  [126:0] rsp_demux_005_src1_data;                                                          // rsp_demux_005:src1_data -> rsp_mux_005:sink1_data
	wire          rsp_demux_005_src1_ready;                                                         // rsp_mux_005:sink1_ready -> rsp_demux_005:src1_ready
	wire    [5:0] rsp_demux_005_src1_channel;                                                       // rsp_demux_005:src1_channel -> rsp_mux_005:sink1_channel
	...
	wire    [5:0] cmd_demux_src2_channel;                                                           // cmd_demux:src2_channel -> nios_cpu_1_data_master_to_sdram_s1_cmd_width_adapter:in_channel
	...
	wire    [5:0] nios_cpu_1_data_master_to_sdram_s1_cmd_width_adapter_src_channel;                 // nios_cpu_1_data_master_to_sdram_s1_cmd_width_adapter:out_channel -> cmd_mux_002:sink0_channel
	...
	wire    [5:0] cmd_demux_001_src2_channel;                                                       // cmd_demux_001:src2_channel -> nios_cpu_1_instruction_master_to_sdram_s1_cmd_width_adapter:in_channel
	...
	wire    [5:0] nios_cpu_1_instruction_master_to_sdram_s1_cmd_width_adapter_src_channel;          // nios_cpu_1_instruction_master_to_sdram_s1_cmd_width_adapter:out_channel -> cmd_mux_002:sink1_channel
	...
	wire    [5:0] cmd_demux_002_src0_channel;                                                       // cmd_demux_002:src0_channel -> hps_0_h2f_axi_master_wr_to_sdram_s1_cmd_width_adapter:in_channel
	...
	wire    [5:0] hps_0_h2f_axi_master_wr_to_sdram_s1_cmd_width_adapter_src_channel;                // hps_0_h2f_axi_master_wr_to_sdram_s1_cmd_width_adapter:out_channel -> cmd_mux_002:sink2_channel
	...
	wire    [5:0] cmd_demux_003_src0_channel;                                                       // cmd_demux_003:src0_channel -> hps_0_h2f_axi_master_rd_to_sdram_s1_cmd_width_adapter:in_channel
	...
	wire    [5:0] hps_0_h2f_axi_master_rd_to_sdram_s1_cmd_width_adapter_src_channel;                // hps_0_h2f_axi_master_rd_to_sdram_s1_cmd_width_adapter:out_channel -> cmd_mux_002:sink3_channel
	...
	wire    [5:0] rsp_demux_002_src0_channel;                                                       // rsp_demux_002:src0_channel -> sdram_s1_to_nios_cpu_1_data_master_rsp_width_adapter:in_channel
	...
	wire    [5:0] sdram_s1_to_nios_cpu_1_data_master_rsp_width_adapter_src_channel;                 // sdram_s1_to_nios_cpu_1_data_master_rsp_width_adapter:out_channel -> rsp_mux:sink2_channel
	...
	wire    [5:0] rsp_demux_002_src1_channel;                                                       // rsp_demux_002:src1_channel -> sdram_s1_to_nios_cpu_1_instruction_master_rsp_width_adapter:in_channel
	...
	wire    [5:0] sdram_s1_to_nios_cpu_1_instruction_master_rsp_width_adapter_src_channel;          // sdram_s1_to_nios_cpu_1_instruction_master_rsp_width_adapter:out_channel -> rsp_mux_001:sink2_channel
	...
	wire    [5:0] rsp_demux_002_src2_channel;                                                       // rsp_demux_002:src2_channel -> sdram_s1_to_hps_0_h2f_axi_master_wr_rsp_width_adapter:in_channel
	...
	wire    [5:0] sdram_s1_to_hps_0_h2f_axi_master_wr_rsp_width_adapter_src_channel;                // sdram_s1_to_hps_0_h2f_axi_master_wr_rsp_width_adapter:out_channel -> rsp_mux_002:sink0_channel
	...
	wire    [5:0] rsp_demux_002_src3_channel;                                                       // rsp_demux_002:src3_channel -> sdram_s1_to_hps_0_h2f_axi_master_rd_rsp_width_adapter:in_channel
	...
	wire    [5:0] sdram_s1_to_hps_0_h2f_axi_master_rd_rsp_width_adapter_src_channel;                // sdram_s1_to_hps_0_h2f_axi_master_rd_rsp_width_adapter:out_channel -> rsp_mux_003:sink0_channel
	...
	wire    [5:0] nios_cpu_1_data_master_limiter_cmd_valid_data;                                    // nios_cpu_1_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [5:0] nios_cpu_1_instruction_master_limiter_cmd_valid_data;                             // nios_cpu_1_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	wire    [5:0] hps_0_h2f_lw_axi_master_wr_limiter_cmd_valid_data;                                // hps_0_h2f_lw_axi_master_wr_limiter:cmd_src_valid -> cmd_demux_004:sink_valid
	wire    [5:0] hps_0_h2f_lw_axi_master_rd_limiter_cmd_valid_data;                                // hps_0_h2f_lw_axi_master_rd_limiter:cmd_src_valid -> cmd_demux_005:sink_valid
	...
	arm_one_nios_mm_interconnect_0_router_011 router_011 (
	...
	arm_one_nios_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (nios_cpu_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arm_one_nios_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (nios_cpu_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
